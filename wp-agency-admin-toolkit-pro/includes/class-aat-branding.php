...
class AAT_Branding {
    ...
    private function safe_overlay($value) {
    ...
    public function login_styles() {
        ...
        $site_logo = esc_url($this->get_site_logo_url());
        $agency_logo = $this->get_agency_logo_url();
        $background = sanitize_hex_color($s['login_background'] ?? '') ?: '#f7f8fb';
        $bg_image = !empty($s['login_background_image_url']) ? esc_url($s['login_background_image_url']) : '';
        $overlay = $this->safe_overlay($s['login_background_overlay'] ?? 'rgba(23,36,59,0.28)');
        ...
        <style id="aat-login-branding">
            ...
            body.login {
                ...
                <?php if ($bg_image): ?>
                background-image: linear-gradient(<?php echo esc_attr($overlay); ?>, <?php echo esc_attr($overlay); ?>), url('<?php echo $bg_image; ?>') !important;
            ...
            <?php if ($site_logo): ?>
            body.login h1 a { background-image: url('<?php echo $site_logo; ?>') !important; }
            <?php else: ?>
            body.login h1 a {
            ...
            body.login h1 a:before {
                ...
                padding: 12px 18px;
                color: <?php echo esc_attr($button); ?>;
                font-size: 24px;
                font-weight: 800;
    ...
    public function admin_styles() {
        ...
        $logo = esc_url($this->get_site_logo_url());
        ?>
        <style id="aat-wp-admin-branding">
            ...
            #adminmenu .wp-submenu { background: #0f192b !important; }
            ...
            .wp-core-ui .button-primary:hover, .wp-core-ui .button-primary:focus { background: #0f192b !important; border-color: #0f192b !important; }
            a, .subsubsub a .count { color: <?php echo esc_attr($primary); ?>; }
            a:hover, a:focus { color: #0f192b; }
            .notice-info, div.updated { border-left-color: <?php echo esc_attr($accent); ?> !important; }
            #wp-admin-bar-wp-logo{display:none!important;}
            <?php if ($logo): ?>
            #wp-admin-bar-root-default:before{
                content:'';display:block;float:left;width:32px;height:32px;margin:0 8px 0 4px;background:url('<?php echo $logo; ?>') center center/contain no-repeat;
            }
            <?php endif; ?>
        </style>
        <?php
